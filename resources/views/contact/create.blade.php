        ...
        <div class="row">            
            ...
            <div class="clearfix"></div>
                ...
                <div class="col-md-2">
                   <div class="form-group">
                       <lable>الكتف</lable>
                       <input type="text" class="form-control"  name="ketf">
                   </div>
                </div>
                <div class="col-md-2">
                   <div class="form-group">
                ...
                <div class="col-md-2">
                   <div class="form-group">
                       ...
                       <input type="text" class="form-control"  name="sadr_width">
                   </div>
                </div>
                <div class="col-md-2">
                   <div class="form-group">
                       <lable> الكبك</lable>
                       <input type="text" class="form-control"  name="kbk">
                   </div>
                </div>
                 <div class="col-md-2">
                   <div class="form-group">
                       <lable> وسع الصدر</lable>
                       <input type="text" class="form-control"  name="hand_width">
                   </div>
                </div>
