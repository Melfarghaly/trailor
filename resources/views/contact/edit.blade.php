...
<div class="col-md-2">
                   <div class="form-group">
                       <lable>الطول</lable>
                       <input type="text" class="form-control"  name="tall" value="{{$contact->tall}}">
                   </div>
                </div>
                <div class="col-md-2">
                   <div class="form-group">
                       <lable>الكتف</lable>
                       <input type="text" class="form-control"  name="ketf" value="{{$contact->ketf}}">
                   </div>
                </div>
                <div class="col-md-2">
                   <div class="form-group">
                       <lable>الرقبة</lable>
                       <input type="text" class="form-control"  name="neck" value="{{$contact->neck}}">
                   </div>
                </div>
                <div class="col-md-2">
                   <div class="form-group">
                       <lable>الوسع</lable>
                       <input type="text" class="form-control"  name="width" value="{{$contact->width}}">
                   </div>
                </div>
                <div class="col-md-2">
                   <div class="form-group">
                       <lable>وسع الصدر</lable>
                       <input type="text" class="form-control"  name="sadr_width" value="{{$contact->sadr_width}}">
                   </div>
                </div>
                <div class="col-md-2">
                   <div class="form-group">
                       <lable> الكبك</lable>
                       <input type="text" class="form-control"  name="kbk" value="{{$contact->kbk}}">
                   </div>
                </div>
                 <div class="col-md-2">
                   <div class="form-group">
                       <lable> وسع الصدر</lable>
                       <input type="text" class="form-control"  name="hand_width" value="{{$contact->hand_width}}">
                   </div>
                </div>
