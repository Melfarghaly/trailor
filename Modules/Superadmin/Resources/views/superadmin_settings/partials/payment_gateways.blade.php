...
<div class="pos-tab-content">
    ...
    <div class="clearfix"></div>
        ...
        <h4>PayMob Egypt: <small>(For Egypt)</small></h4>
        <div class="col-xs-6">
            <div class="form-group">
                {!! Form::label('PAYMOB_API_KEY', 'api key:') !!}
                {!! Form::text('PAYMOB_API_KEY', $default_values['PAYMOB_API_KEY'], ['class' => 'form-control']); !!}
            </div>
        </div>
        <div class="col-xs-6">
            <div class="form-group">
                {!! Form::label('MOBILE_WALLET_INTEGRATION_ID', 'Mobile Wallet Integration ID:') !!}
                {!! Form::text('MOBILE_WALLET_INTEGRATION_ID', $default_values['MOBILE_WALLET_INTEGRATION_ID'], ['class' => 'form-control']); !!}
            </div>
        </div>
        
        <div class="col-xs-6">
            <div class="form-group">
                {!! Form::label('ONLINE_CARD_INTEGRATION_ID', 'Online Card Integration ID :') !!}
                {!! Form::text('ONLINE_CARD_INTEGRATION_ID', $default_values['ONLINE_CARD_INTEGRATION_ID'], ['class' => 'form-control']); !!}
            </div>
        </div>
        <div class="col-xs-6">
            <div class="form-group">
                {!! Form::label('ONLINE_CARD_IFRAME_ID', 'Online Card Iframe ID :') !!}
                {!! Form::text('ONLINE_CARD_IFRAME_ID', $default_values['ONLINE_CARD_IFRAME_ID'], ['class' => 'form-control']); !!}
            </div>
        </div>
        <div class="clearfix"></div>
</div>