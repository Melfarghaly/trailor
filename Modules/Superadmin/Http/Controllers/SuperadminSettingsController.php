...
class SuperadminSettingsController extends BaseController
{
    ...
    public function edit()
    {
        ...
        $default_values = [
            ...
            //PAYMOB API 
            'PAYMOB_API_KEY' => $is_demo ? null : env('PAYMOB_API_KEY'),
            'ONLINE_CARD_INTEGRATION_ID' => $is_demo ? null : env('ONLINE_CARD_INTEGRATION_ID'),
            'ONLINE_CARD_IFRAME_ID' => $is_demo ? null : env('ONLINE_CARD_IFRAME_ID'),
            'ONLINE_CARD_IFRAME_ID' => $is_demo ? null : env('ONLINE_CARD_IFRAME_ID')
        ];
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            $env_settings =  $request->only(['APP_NAME', 'APP_TITLE',
                ...
                //PAYMOB API
                'ONLINE_CARD_IFRAME_ID','MOBILE_WALLET_INTEGRATION_ID','ONLINE_CARD_INTEGRATION_ID','PAYMOB_API_KEY'
            ]);
